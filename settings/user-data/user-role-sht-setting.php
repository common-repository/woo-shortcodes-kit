...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionwshkuserrole()" onmouseout="outFuncwshkuserrole()">
  <span class="tooltiptext" id="myTooltipwshkuserrole"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionwshkuserrole() {
  ...
  tooltipwshkuserrole.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncwshkuserrole() {
  var tooltipwshkuserrole = document.getElementById("myTooltipwshkuserrole");
  tooltipwshkuserrole.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
...
<br><br><br>
    ...
    <option <?php if (get_option('wshk_userroleoptions') == '2') { ?>selected="true" <?php }; ?> value="2"><?php esc_html_e( 'Main user role', 'wshk' ); ?></option> 
    
    <option <?php if (get_option('wshk_userroleoptions') == '1') { ?>selected="true" <?php }; ?> value="1"><?php esc_html_e( 'All user roles', 'wshk' ); ?></option> 
