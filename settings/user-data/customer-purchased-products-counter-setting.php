...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/customer-purchased-products-counter/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br><br>
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctiontotalboupro()" onmouseout="outFunctotalboupro()">
  <span class="tooltiptext" id="myTooltiptotalboupro"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctiontotalboupro() {
  ...
  tooltiptotalboupro.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFunctotalboupro() {
  var tooltiptotalboupro = document.getElementById("myTooltiptotalboupro");
  tooltiptotalboupro.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
...
<br><br><br>
    <p><b>2.- <?php esc_html_e( 'Write the prefix and suffix texts to show.', 'wshk' ); ?></b><br><small><?php esc_html_e( 'Each field shows an example of what to write, but by default it only will show the quantity of purchased products, you must complete the fields that will be displayed', 'wshk' ); ?></small></p>
