...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/user-gravatar-image-shortcode/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctiongravatar()" onmouseout="outFuncgravatar()">
  <span class="tooltiptext" id="myTooltipgravatar"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctiongravatar() {
  ...
  tooltipgravatar.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncgravatar() {
  var tooltipgravatar = document.getElementById("myTooltipgravatar");
  tooltipgravatar.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
...
<br><br><br>
    ...
    <p><b>2.- <?php esc_html_e( 'Style settings', 'wshk' ); ?></b><br><small><?php esc_html_e( 'Each field shows an example of what to write, but you must complete the fields for the image to be displayed', 'wshk' ); ?></small></p>
    
    
    <br /><br /><table>
    <tr>
    <td class="forsmalldropdowns" style="padding: 30px; width: 50%;">
    <p> <?php esc_html_e( 'Gravatar size:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="number" id="wshk_textgravasize" name="wshk_textgravasize" value="<?php if(get_option('wshk_textgravasize')!=''){ echo get_option('wshk_textgravasize'); }?>" placeholder="128px"/ size="50"><br /></p>
    
    <p> <?php esc_html_e( 'Gravatar shadow:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_textgravashd" name="wshk_textgravashd" value="<?php if(get_option('wshk_textgravashd')!=''){ echo get_option('wshk_textgravashd'); }?>" placeholder="5px 5px 5px #c6adc2"/ size="50"><br /></p>
    
     <p> <?php esc_html_e( 'Border size:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="number" id="wshk_textgravabdsz" name="wshk_textgravabdsz" value="<?php if(get_option('wshk_textgravabdsz')!=''){ echo get_option('wshk_textgravabdsz'); }?>" placeholder="4px"/ size="20"><br /></p>
    <br /><br />
    </td>
    ...
    <p> <?php esc_html_e( 'Border type:', 'wshk' ); ?><br><br />
    ...
    <p> <?php esc_html_e( 'Boder color:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_textgravabdcl" name="wshk_textgravabdcl" value="<?php if(get_option('wshk_textgravabdcl')!=''){ echo get_option('wshk_textgravabdcl'); }?>" placeholder="#ffffff"/ size="20"><br /></p>    
    
    <p> <?php esc_html_e( 'Border radius:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="number" id="wshk_textgravabdrd" name="wshk_textgravabdrd" value="<?php if(get_option('wshk_textgravabdrd')!=''){ echo get_option('wshk_textgravabdrd'); }?>" placeholder="100%"/ size="20"><br /></p>
    <br /><br /></td>
...
if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
    ...
    ?>
    <p><b>3.- <?php esc_html_e( 'Customer avatar uploader', 'wshk' ); ?></b> <span style="background-color:#a46497;padding:5px;color:white;border-radius:6px;font-weight:bold;font-size:10px;line-height:2;">WSHK PRO</span><br><small style="margin-top:5px;"><?php esc_html_e( 'You can provide to your customers the possibility to upload a custom profile image from the edit account form and also display it with a shortcode where you need.', 'wshk' ); ?><br><?php esc_html_e( 'To get it, you need the addon', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="https://disespubli.com/producto/custom-blocks-and-redirections-addon-for-wshk/" target="_blank"><?php esc_html_e( 'WSHK PRO', 'wshk' ); ?></a> <?php esc_html_e( 'and activate your', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="/wp-admin/admin.php?page=custom-redirections-for-wshk" target="_blank"><?php esc_html_e( 'License key', 'wshk' ); ?></a>.</small></p>	
    <?php
    }
    ?>
    <!--<p><b>3.- <?php esc_html_e( 'Customer avatar uploader', 'wshk' ); ?></b><br><small><?php esc_html_e( 'You can provide to your customers the possibility to upload a custom profile image from the edit account form.', 'wshk' ); ?><br><?php esc_html_e( 'To get it, you need the addon', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="https://disespubli.com/producto/custom-blocks-and-redirections-addon-for-wshk/" target="_blank"><?php esc_html_e( 'WSHK PRO', 'wshk' ); ?></a></small></p>-->
    <br /><br />
    </div>