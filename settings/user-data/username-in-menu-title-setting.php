...
<div class="panel"> 
<br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/username-in-menu-title/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionwshkuserinmenu()" onmouseout="outFuncwshkuserinmenu()">
  <span class="tooltiptext" id="myTooltipwshkuserinmenu"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionwshkuserinmenu() {
  ...
  tooltipwshkuserinmenu.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncwshkuserinmenu() {
  var tooltipwshkuserinmenu = document.getElementById("myTooltipwshkuserinmenu");
  tooltipwshkuserinmenu.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
</script></big><br /><br /> </p></td>
        
        <td class="shtboxthree" style="width: 53%; padding-left: 30px;"><p><span class="dashicons dashicons-warning"></span><big style="font-size:14px !important;"><strong><?php esc_html_e( 'Copy the shortcode and paste on any page or post', 'wshk' ); ?></strong></big><br /><br /></p></td></tr>
...
<br><br><br>
    <p><b>2.- <?php esc_html_e( 'Display options', 'wshk' ); ?></b><br><small><?php esc_html_e( 'Choose what should display the shortcode', 'wshk' ); ?></small></p>
    <br />


    <!--<p> <?php esc_html_e( 'Choose the option that you want display with this shortcode', 'wshk' ); ?>-->
    ...
    <option <?php if (get_option('wshk_userinmenuoptions') == 'showus') { ?>selected="true" <?php }; ?> value="showus"><?php esc_html_e( 'Login user', 'wshk' ); ?></option> 
    
    <option <?php if (get_option('wshk_userinmenuoptions') == 'showonly') { ?>selected="true" <?php }; ?> value="showonly"><?php esc_html_e( 'Only the name', 'wshk' ); ?></option> 
    
    <option <?php if (get_option('wshk_userinmenuoptions') == 'showdispl') { ?>selected="true" <?php }; ?> value="showdispl"><?php esc_html_e( 'Display name', 'wshk' ); ?></option> 
