...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/username-shortcode/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionusername()" onmouseout="outFuncusername()">
  <span class="tooltiptext" id="myTooltipusername"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionusername() {
  ...
  tooltipusername.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncusername() {
  var tooltipusername = document.getElementById("myTooltipusername");
  tooltipusername.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
    ...
    <br><br><br>
    <p><b>2.- <?php esc_html_e( 'Function and Style settings', 'wshk' ); ?></b><br><small><?php esc_html_e( 'Each field shows an example of what to write, but you must complete the fields for the username to be displayed', 'wshk' ); ?></small></p>
    <br /><br />
    ...
    <p> <?php esc_html_e( 'Text prefix:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_textusernmpf" name="wshk_textusernmpf" value="<?php if(get_option('wshk_textusernmpf')!=''){ echo get_option('wshk_textusernmpf'); }?>" placeholder="<?php esc_html_e( "Hello", "wshk" ); ?>"/ size="50"><br /></p>
    
    <p> <?php esc_html_e( 'Text suffix:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_textusernmsf" name="wshk_textusernmsf" value="<?php if(get_option('wshk_textusernmsf')!=''){ echo get_option('wshk_textusernmsf'); }?>" placeholder="!"/ size="50"><br /></p> 
    
     <p> <?php esc_html_e( 'Choose the option that you want display with this shortcode', 'wshk' ); ?><br /><br /> <select name="wshk_showusername" id="wshk_showusername" style="border-bottom:1px solid #ddd !important;border-radius:4px;padding:10px;width:100%;"> <option <?php if (get_option('wshk_showusername') == 'showus') { ?>selected="true" <?php }; ?> value="showus"><?php esc_html_e( 'Login user', 'wshk' ); ?></option> <option <?php if (get_option('wshk_showusername') == 'showonly') { ?>selected="true" <?php }; ?> value="showonly"><?php esc_html_e( 'Only the name', 'wshk' ); ?></option> <option <?php if (get_option('wshk_showusername') == 'showdispl') { ?>selected="true" <?php }; ?> value="showdispl"><?php esc_html_e( 'Display name', 'wshk' ); ?></option> </select> <br /></p>
    <br /><br /><br />
    </td>
    <td class="forsmalldropdowns" style="padding: 30px; border-left: 1px solid; width: 50%;">    
    
    <p> <?php esc_html_e( 'Text color:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_usernmtc" name="wshk_usernmtc" value="<?php if(get_option('wshk_usernmtc')!=''){ echo get_option('wshk_usernmtc'); }?>" placeholder="#ffffff"/ size="20"><br /></p>
    
    <p> <?php esc_html_e( 'Text size:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="number" id="wshk_usernmts" name="wshk_usernmts" value="<?php if(get_option('wshk_usernmts')!=''){ echo get_option('wshk_usernmts'); }?>" placeholder="16"/ size="20"><br /></p>
    
    <p> <?php esc_html_e( 'Text align:', 'wshk' ); ?><br /><br /> 
    
    <select name="wshk_usernmta" id="wshk_usernmta" style="border-bottom:1px solid #ddd !important;border-radius:4px;padding:10px;width:100%;"> <option <?php if (get_option('wshk_usernmta') == 'left') { ?>selected="true" <?php }; ?> value="left"><?php esc_html_e( 'Left', 'wshk' ); ?></option> <option <?php if (get_option('wshk_usernmta') == 'center') { ?>selected="true" <?php }; ?> value="center"><?php esc_html_e( 'Center', 'wshk' ); ?></option> <option <?php if (get_option('wshk_usernmta') == 'right') { ?>selected="true" <?php }; ?> value="right"><?php esc_html_e( 'Right', 'wshk' ); ?></option> </select>
    <br /></p>
    <br /><br /></td>
