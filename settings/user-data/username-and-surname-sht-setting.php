...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/user-name-and-surname-shortcode/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionnsurname()" onmouseout="outFuncnsurname()">
  <span class="tooltiptext" id="myTooltipnsurname"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionnsurname() {
  ...
  tooltipnsurname.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncnsurname() {
  var tooltipnsurname = document.getElementById("myTooltipnsurname");
  tooltipnsurname.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
</script></big><br /><br /> </p></td>
        
        <td class="shtboxthree" style="width: 46%; padding-left: 30px;"><p><span class="dashicons dashicons-warning"></span><big style="font-size:14px !important;"><strong><?php esc_html_e( 'Copy the shortcode and paste in your custom account page', 'wshk' ); ?></strong></big><br /><br /></p></td></tr>
