...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/restrict-content-to-users-if-they-are-not-logged-in/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br><br>
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionrestnonlog()" onmouseout="outFuncrestnonlog()">
  <span class="tooltiptext" id="myTooltiprestnonlog"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionrestnonlog() {
  ...
  tooltiprestnonlog.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncrestnonlog() {
  var tooltiprestnonlog = document.getElementById("myTooltiprestnonlog");
  tooltiprestnonlog.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
