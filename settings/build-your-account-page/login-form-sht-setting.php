...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/login-form-shortcode/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
    ...
    <br><br>
    <p class="wshkfirststepfunc"><b>1.- <?php esc_html_e( 'The shortcode', 'wshk' ); ?></b><br><small><?php esc_html_e( 'You can use it in your custom account page and also in other pages, posts, products pages and where you need!', 'wshk' ); ?></small></p>
    <br><br><br>
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionloginform()" onmouseout="outFuncloginform()">
  <span class="tooltiptext" id="myTooltiploginform"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionloginform() {
  ...
  tooltiploginform.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncloginform() {
  var tooltiploginform = document.getElementById("myTooltiploginform");
  tooltiploginform.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
...
<br><br><br>
   ...
   <p><b>2.- <?php esc_html_e( 'Choose the page to redirect the user after login', 'wshk' ); ?></b><br><small><?php esc_html_e( 'Use it if you are building your own myaccount page or want redirect the user to a specific page after the login.', 'wshk' ); ?></small></p> 
...
$getoplogin = get_option('wshk_loginredi');
 ?>
 <option style="background-color:#a46497;color:white;" value="<?php echo $getoplogin; ?>" selected ><?php esc_html_e( 'Selected: ', 'wshk' );  foreach($pages as $page): if($page->post_name == $getoplogin): echo $page->post_title; endif; endforeach; ?></option>
</select>
    </p>
    <br><br>
    <p><b>2.1.- <?php esc_html_e( 'Redirect to previous visited page', 'wshk' ); ?></b><br><small><?php esc_html_e( 'After the login, the user will be redirected to the previously visited page and, if this is not possible, will be redirected to the page selected in step 2.', 'wshk' ); ?><br><?php esc_html_e( 'When this option is enabled, it replaces the page selected in step 2', 'wshk' ); ?></small></p>
    ...
    <!--<p><b>3.- <?php esc_html_e( 'Custom redirections by role', 'wshk' ); ?></b><br><small><?php esc_html_e( 'After the login the users with a specific role will be redirected to the selected page.', 'wshk' ); ?><br><?php esc_html_e( 'This option is compatible with all the options availables on the step 2.', 'wshk' ); ?></small></p>
    
    <p class="wshkfunctinputs"><input type="checkbox" id="wshk_enablecustrediroladmin" name="wshk_enablecustrediroladmin" value='wshkroladminactiv' <?php if(get_option('wshk_enablecustrediroladmin')!=''){ echo ' checked="checked"'; }?> /><label for="wshk_enablecustrediroladmin"><?php esc_html_e( 'Redirection for Admin role', 'wshk' ); ?></label></p>
    <br />
    <br />-->
    </div>