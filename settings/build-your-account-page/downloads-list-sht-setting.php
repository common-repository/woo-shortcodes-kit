...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/downloads-list-shortcode/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
...
<button class="wshkshtboxesbtn" type="button" onclick="myFunctiondownloads()" onmouseout="outFuncdownloads()">
  <span class="tooltiptext" id="myTooltipdownloads"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctiondownloads() {
  ...
  tooltipdownloads.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncdownloads() {
  var tooltipdownloads = document.getElementById("myTooltipdownloads");
  tooltipdownloads.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
