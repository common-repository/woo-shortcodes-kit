...
<div class="panel">
    ...
    <table style="float:right;">
        <tr>
            <td><a class="miraqueben" href="https://disespubli.com/docs/display-max-or-min-price-on-variable-products/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a>
            </td>
        </tr>
    </table>
    <br><br><br>
    <p class="wshkfirststepfunc"><?php esc_html_e( 'After enable this function, if you have any variable products it will display the max or min price... depending of what do you have choosed on the function options.', 'wshk' ); ?>
    </p> 
    <p><?php esc_html_e( 'It also works with variable products on sale!', 'wshk' ); ?>
    </p> 
    <br><br>
    <p><b>1.- <?php esc_html_e( 'Choose between display the max or min price:', 'wshk' ); ?></b><br><small><?php esc_html_e( 'By default is selected the option to display the max price.', 'wshk' ); ?></small>
    </p>
    <br>
    <?php
    //Integrate
    ...
    <select name="wshk_minpricevarpro" id="wshk_minpricevarpro" style="border: 1px solid #ddd !important;border-radius: 13px;padding: 10px;width: 50%;" <?php //echo $getdisableopt;?>>
        <option <?php if (get_option('wshk_minpricevarpro') == 'wshk_maxpricevarpro') { ?>selected="true" <?php }; ?> value="wshk_maxpricevarpro"><?php esc_html_e( 'Display the max price on variable products', 'wshk' ); ?></option> 
        
        <option <?php if (get_option('wshk_minpricevarpro') == 'wshk_minpricevarpro') { ?>selected="true" <?php }; ?> value="wshk_minpricevarpro"><?php esc_html_e( 'Display the min price on variable products', 'wshk' ); ?></option>  
    </select>
    <br /></p>
    <br><br>
    <?php
    ...
    if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) && CustomBlocksandRedirectionsBase::CheckWPPlugin($licenseCode,$licenseEmail,$error,$responseObj,__FILE__) ) {?>
        ...
        <table cellspacing="25" style="width:800px;">
            <tr>
                ...
                <span><b><?php esc_html_e( 'Prefix for min price on variable products', 'wshk' ); ?></b></span>
                ...
                <input class="testininputclass" type="text" name="wshk_mintextvarpro" id="wshk_mintextvarpro" value="<?php if(get_option('wshk_mintextvarpro')!=''){ echo get_option('wshk_mintextvarpro'); }/*else {echo 'From';}*/?>" placeholder="From" size="10" />
                 ...
                 <span><b><?php esc_html_e( 'Prefix for max price on variable products', 'wshk' ); ?></b></span>
                ...
                <span><b><?php esc_html_e( 'Suffix for min price on variable products', 'wshk' ); ?></b></span>
                ...
                <span><b><?php esc_html_e( 'Suffix for max price on variable products', 'wshk' ); ?></b></span>
    ...
    ?>    
    <p><b>2.- <?php esc_html_e( 'Add your custom Prefix and Suffix', 'wshk' ); ?></b> <span style="background-color:#a46497;padding:5px;color:white;border-radius:6px;font-weight:bold;font-size:10px;line-height:2;">WSHK PRO</span><br><small style="margin-top:5px;"><?php esc_html_e( 'By default the function will show a prefix, but you can replace it with your custom prefix and also add a custom suffix.', 'wshk' ); ?><br><?php esc_html_e( 'To get it, you need the addon', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="https://disespubli.com/producto/custom-blocks-and-redirections-addon-for-wshk/" target="_blank"><?php esc_html_e( 'WSHK PRO', 'wshk' ); ?></a> <?php esc_html_e( 'and activate your', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="/wp-admin/admin.php?page=custom-redirections-for-wshk" target="_blank"><?php esc_html_e( 'License key', 'wshk' ); ?></a>.</small></p>
    <?php
    }
    ?>
    <br><br>
