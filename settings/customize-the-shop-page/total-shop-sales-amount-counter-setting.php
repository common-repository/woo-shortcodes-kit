...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/total-shop-sales-amount-counter/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br><br>
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctionglobalsalamount()" onmouseout="outFuncglobalsalamount()">
  <span class="tooltiptext" id="myTooltipglobalsalamount"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctionglobalsalamount() {
  ...
  tooltipglobalsalamount.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFuncglobalsalamount() {
  var tooltipglobalsalamount = document.getElementById("myTooltipglobalsalamount");
  tooltipglobalsalamount.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
...
<br><br>
<p style="padding-left:30px;"><?php esc_html_e( 'This shortcode shows total amount sales, adding orders with status processing, completed and on hold', 'wshk' ); ?></p>
<br><br><br>
        </div>