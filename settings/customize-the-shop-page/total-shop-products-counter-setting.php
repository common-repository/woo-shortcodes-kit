...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/total-shop-products-counter/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br><br>
...
<button class="wshkshtboxesbtn" style="width:150px;" type="button" onclick="myFunctiontotalproco()" onmouseout="outFunctotalproco()">
  <span class="tooltiptext" id="myTooltiptotalproco"><?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?></span>
...
function myFunctiontotalproco() {
  ...
  tooltiptotalproco.innerHTML = "<?php esc_html_e( 'Copied:', 'wshk' ); ?> " + copyText.value;
}

function outFunctotalproco() {
  var tooltiptotalproco = document.getElementById("myTooltiptotalproco");
  tooltiptotalproco.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'wshk' ); ?>";
}
...
<br><br>
        <p style="padding-left:30px;"><?php esc_html_e( 'if you want exclude any category from the total count use', 'wshk' ); ?><strong> [woo_total_product_count cat_id="<?php esc_html_e( 'Here write the category ID number', 'wshk' ); ?>"]</strong></p>
        <br>
        <p style="padding-left:30px;"><?php esc_html_e( 'Now you can exclude up to 3 differents categories, for example', 'wshk' ); ?>:<br><strong> [woo_total_product_count cat_id="26" cat_id2="28" cat_id3="23"]</strong></p>
        <br>
        <br>
        <?php
    //Integrate
    ...
    <p><b>2.- <?php esc_html_e( 'Increase the total shop products counter', 'wshk' ); ?></b> <span style="background-color:#a46497;padding:5px;color:white;border-radius:6px;font-weight:bold;font-size:10px;line-height:2;">WSHK PRO</span><br><small><?php esc_html_e( 'By default the function display the total shop products, but now you can modify it manually and increase the quantity.', 'wshk' ); ?></small>
    </p>
    
    <p style="max-width:320px;width:100%;"> <?php esc_html_e( 'Write here the quantity to increase:', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_fakeaddprodincounter" name="wshk_fakeaddprodincounter" value="<?php if(get_option('wshk_fakeaddprodincounter')!=''){ echo get_option('wshk_fakeaddprodincounter'); }?>" placeholder="<?php esc_html_e( "50", "wshk" ); ?>"/ size="20"><small><?php esc_html_e( 'Also you can use negative quantity to decrease the total.', 'wshk' ); ?></small><br /></p>
    <?php 
    } 
    // GET WSHK PRO
    else {
    ?>    
    <p><b>4.- <?php esc_html_e( 'Increase the total shop products counter', 'wshk' ); ?></b> <span style="background-color:#a46497;padding:5px;color:white;border-radius:6px;font-weight:bold;font-size:10px;line-height:2;">WSHK PRO</span><br><small style="margin-top:5px;"><?php esc_html_e( 'By default the function display the total shop products, but now you can modify it manually and increase the quantity.', 'wshk' ); ?><br><?php esc_html_e( 'To get it, you need the addon', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="https://disespubli.com/producto/custom-blocks-and-redirections-addon-for-wshk/" target="_blank"><?php esc_html_e( 'WSHK PRO', 'wshk' ); ?></a> <?php esc_html_e( 'and activate your', 'wshk' ); ?> <a style="color:#a46497;text-decoration:underline;" href="/wp-admin/admin.php?page=custom-redirections-for-wshk" target="_blank"><?php esc_html_e( 'License key', 'wshk' ); ?></a>.</small></p>
    <?php
    }
    ?>
