...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/build-a-new-shop-page-from-scratch/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br />
    <p class="wshkfirststepfunc"><b>1.- <?php esc_html_e( 'Choose the page of your new shop page', 'wshk' ); ?></b><br><small><?php esc_html_e( 'This function is compatible with any theme and page builder. You can design your new page in the same way as the others.', 'wshk' ); ?></small></p>
...
$getopcushop = get_option('wshk_shopageslug');
 ?>
 <option style="background-color:#a46497;color:white;" value="<?php echo $getopcushop; ?>" selected ><?php esc_html_e( 'Selected: ', 'wshk' );  foreach($pages as $page): if($page->post_name == $getopcushop): echo $page->post_title; endif; endforeach; ?></option>
</select>
        <br><br><br>
        <p><b>2.- <?php esc_html_e( 'Remember go to ', 'wshk' ); ?> <a style="color:#a46497;font-weight:600;text-decoration:underline;" href="<?php echo get_home_url(); ?>/wp-admin/admin.php?page=wc-settings&tab=products" target="_blank"><?php esc_html_e( 'WooCommerce settings', 'wshk' ); ?></a> <?php esc_html_e( ' to disable the shop page option', 'wshk' ); ?></b><br><small><?php esc_html_e( ' Just need click in the WooCommerce settings link and remove the page from the shop page field.', 'wshk' ); ?></small></p>
        <br /><br /><br /> </td>
