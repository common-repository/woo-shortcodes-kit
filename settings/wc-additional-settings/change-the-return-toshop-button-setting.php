...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/change-the-return-to-shop-button-text-and-add-custom-redirection/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br /><br>
             ...
             <p class="forsmalldropdowns" style="width:350px;padding-left: 30px;"> <?php esc_html_e( 'Write the button text', 'wshk' ); ?><br /><br /> <input class="testininputclass" type="text" id="wshk_retshopbtntext" name="wshk_retshopbtntext" value="<?php if(get_option('wshk_retshopbtntext')!=''){ echo get_option('wshk_retshopbtntext'); }?>" placeholder="Return"/ size="20"><br /></p>
             
             
             <p class="forsmalldropdowns" style="padding-left: 30px;"> <?php esc_html_e( 'Choose the page to redirect', 'wshk' ); ?><br /><br /> 
...
$getopbtnredishop = get_option('wshk_retshopurlredi');
 ?>
 <option style="background-color:#a46497;color:white;" value="<?php echo $getopbtnredishop; ?>" selected ><?php esc_html_e( 'Selected: ', 'wshk' );  foreach($pages as $page): if($page->post_name == $getopbtnredishop): echo $page->post_title; endif; endforeach; ?></option>
</select>
             <br /></p>
             <br><br>
             
             <p style="border: 1px solid #ddd;padding: 10px;color: #a46497;"><?php esc_html_e( 'Example', 'wshk' ); ?><br><small style="color:grey;"><?php esc_html_e( 'By default, the button shows the text "Return to shop" and redirects to the default store page, but for example, you can type the text "Go to the store" and choose a different page to redirect.', 'wshk' ); ?></small></p>
             </td>
