...
<div class="panel">
    <br><br>
    <table style="float:right;"><tr><td><a class="miraqueben" href="https://disespubli.com/docs/global-settings/" target="_blank" style="color: grey;"><span class="dashicons dashicons-book"></span> <?php esc_html_e( 'How does it work? ', 'wshk' ); ?> </a></td><td><a class="miraqueben" href="https://disespubli.com/wshk-features/#contact" class="botoneratopadmin" target="_blank" style="color:grey;"><span class="dashicons dashicons-sos"></span> <?php esc_html_e( 'Get help!', 'wshk' ); ?></a></td></tr></table>
    <br /><br /><br>
<p class="wshkfirststepfunc forsmalldropdowns" style="padding-left: 30px;"><?php esc_html_e( 'This settings will be used for 4 different cases (WordPress comments, WooCommerce reviews, register form and checkout page).', 'wshk' ); ?></p>

<table style="width: 100%;"><tr><td class="forsmalldropdowns" style="width: 50%;padding-left:30px;">
    <p style="color:grey;border:1px solid grey; border-radius:13px;padding:15px;"><span class="dashicons dashicons-info"></span> <?php esc_html_e( 'The checkbox message can be configured from here globally or from each function to add a different message in each case.', 'wshk' ); ?></p><br>
    <p><b>1. <?php esc_html_e( 'Write your message for the checkbox:', 'wshk' ); ?> </b><br /><small style="color:grey;"><?php esc_html_e( 'Example: I have read and accept the privacy policy', 'wshk' ); ?></small><br /> <table><tr><td class="forsmalldropdowns"style="width: 50%;"><input class="testininputclass" type="text" name="wshk_gprdiread" id="wshk_gprdiread" value="<?php if(get_option('wshk_gprdiread')!=''){ echo get_option('wshk_gprdiread'); }?>" placeholder="<?php esc_html_e( "Write your custom checkbox message", "wshk" ); ?>" size="60" /></td></tr></table></p>
    
    
     <p><b>2. <?php esc_html_e( 'Set your custom privacy policy page:
', 'wshk' ); ?> </b><br /><small style="color:grey;"><?php esc_html_e( 'The choosed page will be linked with the checkbox message', 'wshk' ); ?></small><br /> <table><tr><td class="forsmalldropdowns" style="width: 50%;">
...
$getopprivpoli = get_option('wshk_gprdurlslug');
 ?>
 <option style="background-color:#a46497;color:white;" value="<?php echo $getopprivpoli; ?>" selected ><?php esc_html_e( 'Selected: ', 'wshk' );  foreach($pages as $page): if($page->post_name == $getopprivpoli): echo $page->post_title; endif; endforeach; ?></option>
</select>
...
';}?></textarea><br /></p>
 ...
 <p style="padding-left:30px;"> <?php esc_html_e( 'Remember go to ', 'wshk' ); ?> <a style="color:#a46497;font-weight:600;text-decoration:underline;" href="<?php echo get_home_url(); ?>/wp-admin/admin.php?page=wc-settings&tab=account" target="_blank"><?php esc_html_e( 'WooCommerce settings', 'wshk' ); ?></a> <?php esc_html_e( ' to disable the WooCommerce Privacy page option and remove the Privacy policy default texts', 'wshk' ); ?><br /></p><br /><br />
    <br />
    <br />
    </div>