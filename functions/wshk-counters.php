...
if ( isset($getenablectbp) && $getenablectbp =='6')
    ...
    function wshk_current_customer_month_count( $user_id=null ) {
        ...
        $args = array(
            // WC orders post type
            'post_type'   => 'shop_order',//wc_get_order_types(),        
            ...
            foreach ( $customer_orders as $customer_order ){
                ...
                if ( $customer_order_date > $gap_time ) {
                    ...
                    foreach ( $order_items as $order_item ){
                        $count += $order_item->get_quantity(); //Display sum of all products purchased by the customer
                        //$count++; //Display total products purchased by customer
                    }                
                } 
            }
        }
