...
if ( isset($getgprdcomments) && $getgprdcomments =='89')
    ...
    function wshk_custom_fields($fields) {
        ...
        if($getgdprcommentsprivacylink !='') {
            ...
            //Global text
            $gdprcommentsprivacylinktext = __('Privacy Policy' , 'wshk');
        }
            ...
            jQuery(document).ready(function($){
                $("#submit").click(function(e){
                    if (!$('.comment-form-policy__input').prop('checked')){
                        e.preventDefault();
                        alert('You must agree to our privacy term by checking the box', 'wshk');
                        return false;
                    }
                })
            });
...
if ( isset($getgprdorders) && $getgprdorders =='90')
    ...
    function wshk_add_checkout_tickbox() {
     ...
     //$pollink = __('Privacy Policy', 'wshk');
     ...
     //Privacy policy link text
        if($getgdprcheckoutprivacylink !='') {
            ...
            //Global text
            $gdprcheckoutprivacylinktext = __('Privacy Policy' , 'wshk');
        }
    ...
    function wshk_not_approved_delivery() {
        if ( ! (int) isset( $_POST['privacy_policy'] ) ) {
            wc_add_notice( __( '<b>Privacy Policy</b> is a required field', 'wshk'), 'error' );
        }
    }
    ...
    function wshk_display_privacy_policy_acceptance( $order ) {
        ...
        if ( $nosignoptoutt == 1) {
            $Privptextaccepted = __( 'Accepted', 'wshk' );
...
if ( isset($getgprdreviews) && $getgprdreviews =='91')
    ...
    function my_revie_form_after_fields() {
     ...
     $urlpoli = '/' . get_option('wshk_gprdurlslug');
     //$polilink = __('Privacy Policy', 'wshk');
     ...
     //Privacy policy link text
        if($getgdprreviewsprivacylink !='') {
            ...
            //Global text
            $gdprreviewsprivacylinktext = __('Privacy Policy' , 'wshk');
        }
...
if ( isset($getgprdwcregisterform) && $getgprdwcregisterform =='9292')
    ...
    function wshk_add_registration_privacy_policy() {
     ...
     //Privacy policy link text
        if($getgdprregisterformprivacylink !='') {
            ...
            //Global text
            $gdprregformprivacylinktext = __('Privacy Policy' , 'wshk');
        }
    ...
    if ( ! is_checkout() ) {
        if ( ! (int) isset( $_POST['privacy_policy_reg'] ) ) {
            $errors->add( 'privacy_policy_reg_error', __( 'You must agree to our privacy term by checking the box', 'wshk') );
        }
    }
    return $errors;
    }
...
//}
    ...
    function wshk_customer_registration_email_alert( $user_id ) {
        ...
        $miasunto = __('New Customer Registration', 'wshk');
        ...
        ', 'wshk' ), $first_name, $last_name, $email ) . $gprduserlegalinfoo ;
...
if ( isset($getwcnewtermsbox) && $getwcnewtermsbox =='94')
    ...
    function wshk_not_approved_privacy() {
        if ( ! (int) isset( $_POST['privacy_terms'] ) ) {
            wc_add_notice( __( '<b>Terms & Conditions</b> is a required field', 'wshk' ), 'error' );
        }
    }
    ...
    function wshk_display_terms_conditions_acceptance( $order ) {
        ...
        if ( $nosignoptout == 1) {
            $tyctextaccepted = __( 'Accepted', 'wshk' );
