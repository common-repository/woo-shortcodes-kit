...
<div class="wshk-tab" id="div-wshk-languages">
    ...
    <h2 class="wshkinfoboxtitle"><span style="color:#a46497; font-size: 26px;"><span class="dashicons dashicons-info"></span> <?php esc_html_e( 'TRANSLATE THE PLUGIN! ', 'wshk' ); ?></span></h2>
    ...
    $poplugin_dir = WP_CONTENT_DIR . '/plugins/wshk/languages/wshk-es_ES.po';
    
    $moplugin_dir = WP_CONTENT_DIR . '/plugins/wshk/languages/wshk-es_ES.mo';
    
  	
  	$pathmo = WP_CONTENT_DIR . '/languages/plugins/wshk-es_ES.mo';
  	$pathpo = WP_CONTENT_DIR . '/languages/plugins/wshk-es_ES.po';
    ...
    $brazpoplugin_dir = WP_CONTENT_DIR . '/plugins/wshk/languages/wshk-pt_BR.po';
    
    $brazmoplugin_dir = WP_CONTENT_DIR . '/plugins/wshk/languages/wshk-pt_BR.mo';
    
    $brapathmo = WP_CONTENT_DIR . '/languages/plugins/wshk-pt_BR.mo';
  	$brapathpo = WP_CONTENT_DIR . '/languages/plugins/wshk-pt_BR.po';
...
$ruta = WP_CONTENT_DIR . '/plugins/wshk/languages/';
$destino= WP_CONTENT_DIR . '/languages/plugins/';
$archivos= glob($ruta.'wshk-es_ES.*o');
...
/*$ruta= plugin_dir_path( __FILE__ ) . '/languages/';*/
$rutabra = WP_CONTENT_DIR . '/plugins/wshk/languages/';
$destinobra = WP_CONTENT_DIR . '/languages/plugins/';
$archivosbra = glob($rutabra.'wshk-pt_BR.*o');
...
//Change the action button text
  ...
  if(file_exists($pathpo)) {
    ...
    $wstitle = __( 'UPDATE', 'wshk' );
    
    } else {
    $wstitle = __( 'COPY', 'wshk' );
    }
    
     if(file_exists($brapathpo)) {
    
    $wstitlebr = __( 'UPDATE', 'wshk' );
    
    } else {
    $wstitlebr = __( 'COPY', 'wshk' );
    }
    
     if(!empty($sysadddestino) && file_exists($sysadddestino)) {
    
    $wstitlee = __( 'UPDATE', 'wshk' );
    
    } else {
    $wstitlee = __( 'COPY', 'wshk' );
    }
    ?>
    
    
    <h3 style="background-color:#a46497;color:white;padding:15px;border:1px solid #a46497;border-radius:13px;margin-bottom:-15px;"><?php esc_html_e( 'Plugin files', 'wshk' ); ?></h3>
    <table width="100%" bgcolor="#fbfbfb" style="color:#000000;border: 1px solid #fbfbfb;border-radius:13px;" cellpading="10" align="center">
         <thead>
    <tr>
      <th width="10%" style="padding:10px;"><?php esc_html_e( 'LANGUAGE', 'wshk' ); ?></th>
      
      <th class="wshklangroot" width="70%" style="padding:10px;"><?php esc_html_e( 'ROOT', 'wshk' ); ?></th>
      <th class="wshklangavail" width="10%" style="padding:10px;"><?php esc_html_e( 'AVAILABLE', 'wshk' ); ?></th>
      <th width="10%" style="padding:10px;"><?php esc_html_e( 'ACTION', 'wshk' ); ?></th>
    </tr>
  </thead>
  <br>
  <tbody>
...
' , __DIR__ );?>" style="width: 48px; height: 48px;padding-bottom: 5px;"></td>
        ...
        <td class="wshklangrootdesc" style="font-size:12px;"><?php if(file_exists($poplugin_dir)) {echo $poplugin_dir; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
        ...
        <td rowspan="2"><?php if(file_exists($poplugin_dir)) {echo '<form method="post"><button style="cursor:pointer;padding:10px 15px 10px 15px;background-color:#a46497;border:1px solid #a46497;border-radius:13px;color:white;" name="wshkesfiles">'.$wstitle.'</button></form>'; } else { echo esc_html_e( 'No available options', 'wshk' );} ?></td>
        </tr>
...
' , __DIR__ );?>" style="width: 24px; height: 24px;padding-bottom: 5px;"></td>-->
        ...
        <!--<td></td>-->
        <td class="wshklangavaildesc" style="font-size:12px;"><?php if(file_exists($moplugin_dir)) {echo $moplugin_dir; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 48px; height: 48px;padding-bottom: 5px;"></td>
        ...
        <td class="wshklangrootdesc" style="padding-top:20px;font-size:12px;"><?php if(file_exists($brazpoplugin_dir)) {echo $brazpoplugin_dir; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 24px; height: 24px;padding-bottom: 5px;"></td>-->
        ...
        <!--<td></td>-->
        <td class="wshklangavaildesc" style="font-size:12px;"><?php if(file_exists($brazmoplugin_dir)) {echo $brazmoplugin_dir; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 48px; height: 48px;padding-bottom: 5px;"></td>
        ...
        <td class="wshklangrootdesc" style="padding-top:20px;font-size:12px;" ><?php if(file_exists($adddestino)) {echo $adddestino; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 24px; height: 24px;padding-bottom: 5px;"></td>-->
        ...
        <!--<td></td>-->
        <td class="wshklangavaildesc" style="font-size:12px;"><?php if(file_exists($addmodestino)) {echo $addmodestino; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
    ...
    <h3 style="background-color:#a46497;color:white;padding:15px;border:1px solid #a46497;border-radius:13px;margin-bottom:-15px;"><?php esc_html_e( 'System files', 'wshk' ); ?></h3>
    <table width="100%" bgcolor="#fbfbfb" style="color:#000000;border: 1px solid #fbfbfb;border-radius:13px;" cellpading="10" align="center">
         <thead>
    <tr>
      <th width="10%" style="padding:10px;"><?php esc_html_e( 'LANGUAGE', 'wshk' ); ?></th>
      <th class="wshklangroot" width="80%" style="padding:10px;"><?php esc_html_e( 'ROOT', 'wshk' ); ?></th>
      <th width="10%" style="padding:10px;"><?php esc_html_e( 'AVAILABLE', 'wshk' ); ?></th>
    </tr>
  </thead>
  <br>
  <tbody>
...
' , __DIR__ );?>" style="width: 48px; height: 48px;padding-bottom: 5px;"></td>
        ...
        <td class="wshklangrootdesc"><?php if(file_exists($pathpo)) {echo $pathpo; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 24px; height: 24px;padding-bottom: 5px;"></td>-->
        ...
        <td class="wshklangrootdesc"><?php if(file_exists($pathmo)) {echo $pathmo; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 48px; height: 48px;padding-bottom: 5px;"></td>
        ...
        <td class="wshklangrootdesc" style="padding-top:20px;"><?php if(file_exists($brapathpo)) {echo $brapathpo; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 24px; height: 24px;padding-bottom: 5px;"></td> -->
        <td class="wshklangrootdesc"><?php if(file_exists($brapathmo)) {echo $brapathmo; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 48px; height: 48px;padding-bottom: 5px;"></td>
        ...
        <td class="wshklangrootdesc" style="padding-top:20px;"><?php if(file_exists($sysadddestino)) {echo $sysadddestino; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
...
' , __DIR__ );?>" style="width: 24px; height: 24px;padding-bottom: 5px;"></td> -->
        ...
        <td class="wshklangrootdesc"><?php if(file_exists($sysaddmodestino)) {echo $sysaddmodestino; } else { echo esc_html_e( 'The file not exist', 'wshk' );} ?></td>
